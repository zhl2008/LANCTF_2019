...
class Ens extends AbstractWeb3Module {
  constructor(provider, providersModuleFactory, methodModuleFactory, options, ensModuleFactory, contractModuleFactory, promiEvent, abiCoder, utils, formatters$$1, registryOptions, net) {
...
class EnsModuleFactory {
  createENS(provider, providersModuleFactory, methodModuleFactory, contractModuleFactory, promiEvent, abiCoder, utils, formatters$$1, net, registryOptions, ensModuleOptions) {
    return new Ens(provider, providersModuleFactory, methodModuleFactory, ensModuleOptions, this, contractModuleFactory, promiEvent, abiCoder, utils, formatters$$1, registryOptions, net);
  }
...
const Ens$1 = (provider, options, accounts) => {
  const abiCoder = new AbiCoder();
  const methodModuleFactory = new MethodModuleFactory();
  return new EnsModuleFactory().createENS(provider, new ProvidersModuleFactory(), new MethodModuleFactory(), new ContractModuleFactory(Utils, formatters, abiCoder, accounts, methodModuleFactory), PromiEvent, abiCoder, Utils, formatters, new Network(provider), {}, options);
};
