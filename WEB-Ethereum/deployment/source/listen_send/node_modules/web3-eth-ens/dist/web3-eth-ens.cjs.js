...
function (_AbstractWeb3Module) {
  ...
  function Ens(provider, providersModuleFactory, methodModuleFactory, options, ensModuleFactory, contractModuleFactory, promiEvent, abiCoder, utils, formatters, registryOptions, net) {
    var _this;
...
function () {
  ...
  _createClass(EnsModuleFactory, [{
    ...
    value: function createENS(provider, providersModuleFactory, methodModuleFactory, contractModuleFactory, promiEvent, abiCoder, utils, formatters, net, registryOptions, ensModuleOptions) {
      return new Ens(provider, providersModuleFactory, methodModuleFactory, ensModuleOptions, this, contractModuleFactory, promiEvent, abiCoder, utils, formatters, registryOptions, net);
    }
  }, {
    key: "createRegistry",
